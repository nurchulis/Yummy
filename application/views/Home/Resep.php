    ...
    <section class="archive-area section_padding_80">
        <div class="container">
            <div class="row">
<?php foreach ($tampil_resep as $tampil) {
  ?>
                <!-- Single Post -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="post-content">
                            ...
                            <a href="<?php echo base_url() ?>Home/Pilih_posting/<?php echo $tampil->id_resep ?>">
                                <h4 class="post-headline"><?php echo $tampil->judul_resep ?></h4>
                            </a>
                        </div>
                    </div>
                </div>
